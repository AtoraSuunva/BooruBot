...
const WHY_SLASH_URL = 'https://gist.github.com/AtoraSuunva/c55dd6c7e157eeb25c26ef09f47790d8'

const buttons: ButtonBuilder[] = [
  new ButtonBuilder().setLabel('Changelog').setStyle(ButtonStyle.Link).setURL(CHANGELOG_URL),
